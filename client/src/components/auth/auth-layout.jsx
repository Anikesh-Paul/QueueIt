...
/** Quiet geometric placeholder for the auth illustration slot. */
function MotifMark() {
  return (
    <svg
      viewBox="0 0 200 200"
    ...
    >
      ...
      <circle cx="110" cy="34" r="14" fill="#F0FDFA" fillOpacity="0.7" />
      <rect x="64" y="88" width="52" height="34" rx="10" fill="#F0FDFA" />
      <rect x="70" y="94" width="40" height="6" rx="3" fill="#0F766E" />
      <rect x="70" y="106" width="24" height="6" rx="3" fill="#0F766E" fillOpacity="0.55" />
      <circle cx="40" cy="130" r="18" fill="#CCFBF1" fillOpacity="0.8" />
      <circle cx="122" cy="134" r="12" fill="#F0FDFA" fillOpacity="0.55" />
      <rect x="22" y="168" width="120" height="16" rx="8" fill="#F0FDFA" fillOpacity="0.9" />
    </svg>
  );
}